...
Future getBoxHive(Object value) async {
  switch (value.runtimeType) {
    ...
    case HouseDto:
      ...
      final boxHouse = await Hive.openBox<KeyHouse>(favoriteNameStorage);
      return boxHouse;
    case SpellDto:
      value as SpellDto;
      ...
      final boxSpel = await Hive.openBox<KeySpel>(favoriteNameStorage);
      return boxSpel;
    default:
      value as WizardDto;
      ...
      final boxWizard = await Hive.openBox<KeyWizard>(favoriteNameStorage);
      return boxWizard;
  }
}
